...
// <body>
//     <div>
//         <h1 id="header">ESP 32 Camera</h1>
//         <h1 id="state">Camera State = on </h1>
...
//         fetch("/state").then(response=>response.text()).then(data=>{console.log(data);stateheader.innerHTML="Camera State is "+data;})

//         startbutton.addEventListener("mousedown",()=>{
//             fetch("/start").then(response=>response.text()).then(data => {console.log(data);stateheader.innerHTML="Camera State is "+data;});
//             startbutton.style.backgroundColor = "green";
            
//         });
//         endbutton.addEventListener("mousedown",()=>{
//             fetch("/stop").then(response =>response.text()).then(data=>{console.log(data);stateheader.innerHTML="Camera State is "+data;});
...
//         });
//         endbutton.addEventListener("mouseup",()=>{
//             endbutton.style.backgroundColor = "lightcoral";
//         });
//     </script>
// </body>
// </html>
            ...
            <div id="percentagetabs">
                ...
                <div class="percentagetabbar">
                    <div class="titles">
                        ...
                        <h4 class="value">55MB</h4>
                        <h4 class="heading">Free Capacity</h4>
                        <h4 class="value">280GB</h4>
                    </div>
                    <div class="percentagebar">
